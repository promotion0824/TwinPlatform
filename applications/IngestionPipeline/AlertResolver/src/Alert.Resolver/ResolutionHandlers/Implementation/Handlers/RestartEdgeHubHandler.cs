...
internal sealed class RestartEdgeHubHandler : RetryableResolutionHandlerBase<ResolutionRequest>, IResolutionHandler<ResolutionRequest>
{
    private readonly ILogger<RestartEdgeHubHandler> _logger;
    private readonly IDeviceService _deviceService;

    public RestartEdgeHubHandler(ILogger<RestartEdgeHubHandler> logger,
