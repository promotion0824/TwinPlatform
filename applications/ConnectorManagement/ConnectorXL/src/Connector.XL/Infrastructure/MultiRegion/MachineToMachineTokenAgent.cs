...
internal class MachineToMachineTokenAgent : IMachineToMachineTokenAgent
{
    ...
    public MachineToMachineTokenAgent(ILogger<MachineToMachineTokenAgent> logger, IHttpClientFactory httpClientFactory, IMemoryCache cache, IMultiRegionSettings regions)
    {
        this.logger = logger;
    ...
    {
        var token = cache.GetOrCreate("MachineToMachineTokens:" + regionId,
            (cacheEntry) =>
            {
