namespace ConnectorCore.Modules
{
    ...
    internal class SetPointCommandsFeatureModule : IFeatureModule
    {
        public void Register(IServiceCollection services, IConfiguration config, IWebHostEnvironment env)
        {
            services.AddTransient<ISetPointCommandsRepository, SetPointCommandsRepository>();
            services.AddTransient<ISetPointCommandsService, SetPointCommandsService>();
        }
