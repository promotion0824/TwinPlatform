namespace ConnectorCore.Modules
{
    ...
    internal class SetPointCommandConfigurationsFeatureModule : IFeatureModule
    {
        public void Register(IServiceCollection services, IConfiguration config, IWebHostEnvironment env)
        {
            services.AddTransient<ISetPointCommandConfigurationsRepository, SetPointCommandConfigurationsRepository>();
            services.AddTransient<ISetPointCommandConfigurationsService, SetPointCommandConfigurationsService>();
        }
