...
public class ConflictResolverAtMostCommandTests
{
    [Fact]
    ...
    [Fact]
    public async Task ConflictResolutionManager_Scenario2a_Conflicting_RequestedCommand_On_Same_Interval__Different_Value_Returns_Single_MinimumValue_ResolvedCommand()
    {
        //Arrange
        var conflictDetector = new ConflictDetector();
        var conflictResolver = new ConflictResolver(conflictDetector);
    ...
    [Fact]
    public async Task ConflictResolutionManager_Scenario2b_Conflicting_RequestedCommand_On_Same_Interval__Different_Value_Returns_Single_MinimumValue_ResolvedCommand()
    {
        //Arrange
        var conflictDetector = new ConflictDetector();
        var conflictResolver = new ConflictResolver(conflictDetector);
    ...
    [Fact]
    public async Task ConflictResolver_Scenario6_Conflicting_RequestedCommand_On_Contained_With_Same_Value_Returns_Single_MinimumValue_ResolvedCommand()
    {
        //Arrange
        var conflictDetector = new ConflictDetector();
        var conflictResolver = new ConflictResolver(conflictDetector);
    ...
    [Fact]
    public async Task ConflictResolver_Scenario7a_Conflicting_RequestedCommand_On_Contained_With_Different_Value_Returns_3_Split_ResolvedCommands()
    {
        //Arrange
        var conflictDetector = new ConflictDetector();
        var conflictResolver = new ConflictResolver(conflictDetector);
    ...
    [Fact]
    public async Task ConflictResolver_Scenario7b_Conflicting_RequestedCommand_On_Contained_With_Different_Value_Returns_3_Split_ResolvedCommands()
    {
        //Arrange
        var conflictDetector = new ConflictDetector();
        var conflictResolver = new ConflictResolver(conflictDetector);
        ...
        var overlappingCommands = new List<RequestedCommand>
        {
            CommandRandomizer.GetRequestedCommand(
                                                  ...
                                                  nameof(SetPointCommandName.atMost),
                                                  inNext2Days.AddHours(1 + 3),
                                                  inNext2Days.AddHours((1 + 6))),//04:00-07:00
            CommandRandomizer.GetRequestedCommand(
                                                  "13018",
                                                  75,
                                                  nameof(SetPointCommandName.atMost),
        ...
        resolvedCommands[1].StartTime.Should().Be(inNext2Days.AddHours(1 + 3));
        resolvedCommands[1].EndTime.Should().Be(inNext2Days.AddHours(1 + 6));
        resolvedCommands[1].RequestedCommand.Value.Should().Be(70);

        //07:00-12:00
        resolvedCommands[2].StartTime.Should().Be(inNext2Days.AddHours(1 + 6));
        resolvedCommands[2].EndTime.Should().Be(inNext2Days.AddHours(1 + 10));
        resolvedCommands[2].RequestedCommand.Value.Should().Be(75);
    }
