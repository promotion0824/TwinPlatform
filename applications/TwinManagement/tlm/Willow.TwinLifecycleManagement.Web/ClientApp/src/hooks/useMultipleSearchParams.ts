...
export default function useMultipleSearchParams(
  ...
  const [searchParams, setSearchParams] = useSearchParams() as [
    URLSearchParams,
    (vals: URLSearchParams | ParamsDict, navigateOptions?: NavigateOptions) => void
  ];
  ...
  const setValues = useCallback(
    (newValues: UpdateParamsDict, overrideNavigateOptions?: NavigateOptions) => {
      ...
      setSearchParams(newSearchParams, overrideNavigateOptions ?? navigateOptions);
    },
