...
namespace Willow.AzureDigitalTwins.Api.UnitTests.Serialization;

public class RuleTemplateSerializerTests
{
    private readonly RuleTemplateSerializer _ruleTemplateSerializer;
    public RuleTemplateSerializerTests()
    {
        _ruleTemplateSerializer = new RuleTemplateSerializer();
    }
    ...
    public void Deserialize_WithIntRangeProperty_ShouldContainIntRangePropertyObject()
    {
        ...
        var rule = _ruleTemplateSerializer.Deserialize(value);
    ...
    public void Serialize_WithIntRangeProperty_ShouldContainIntRangeProperties()
    {
        ...
        var serialized = _ruleTemplateSerializer.Serialize(rule);
