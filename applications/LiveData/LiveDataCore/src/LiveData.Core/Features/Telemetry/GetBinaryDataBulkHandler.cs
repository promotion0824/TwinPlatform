...
internal class GetBinaryDataBulkHandler
{
    public static async Task<Results<Ok<Dictionary<string, IEnumerable<TelemetryBinaryResponseData>>>, UnauthorizedHttpResult, NotFound>> HandleAsync(
