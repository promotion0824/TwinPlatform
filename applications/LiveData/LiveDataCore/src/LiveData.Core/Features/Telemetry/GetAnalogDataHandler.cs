...
internal class GetAnalogDataHandler
{
    public static async Task<Results<Ok<IEnumerable<TelemetryAnalogResponseData>>, UnauthorizedHttpResult, NotFound>> HandleAsync(
