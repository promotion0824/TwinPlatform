...
internal class GetSumDataBulkHandler
{
    public static async Task<Results<Ok<Dictionary<string, IEnumerable<TelemetrySumResponseData>>>, UnauthorizedHttpResult, NotFound>> HandleAsync(
