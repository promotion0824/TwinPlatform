...
internal class GetMultiStateDataHandler
{
    public static async Task<Results<Ok<IEnumerable<TelemetryMultiStateResponseData>>, UnauthorizedHttpResult, NotFound>> HandleAsync(
