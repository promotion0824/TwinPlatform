...
internal class GetMultiStateDataBulkHandler
{
    public static async Task<Results<Ok<Dictionary<string, IEnumerable<TelemetryMultiStateResponseData>>>, UnauthorizedHttpResult, NotFound>> HandleAsync(
        ...
        ITelemetryService telemetryService)
    {
        ...
        var result = await telemetryService.GetTelemetryDataByTwinIdAsync<TelemetryMultiStateResponseData>(clientId,
            start,
            end,
