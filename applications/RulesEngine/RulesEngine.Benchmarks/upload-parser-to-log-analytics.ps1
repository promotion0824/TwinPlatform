...
$json = Invoke-WebRequest -Uri "https://dotnetbenchmarks.blob.core.windows.net/benchmark-results/RulesEngine.Benchmarks.ParserBenchmarks-report.json$SasKey"
...
# Create the function to create the authorisation signature
