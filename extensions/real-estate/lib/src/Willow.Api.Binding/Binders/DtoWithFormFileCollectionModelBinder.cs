...
{
    public class DtoWithFormFileCollectionModelBinder : IModelBinder
    {
        private readonly IOptions<MvcNewtonsoftJsonOptions> _jsonOptions;
        private readonly FormCollectionModelBinder _formFileModelBinder;

        public DtoWithFormFileCollectionModelBinder(IOptions<MvcNewtonsoftJsonOptions> jsonOptions, ILoggerFactory loggerFactory)
        {
            _jsonOptions = jsonOptions;
            _formFileModelBinder = new FormCollectionModelBinder(loggerFactory);
        }
        ...
        public async Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            {
                if (property.ModelType != typeof(IFormFileCollection))
                    continue;
                ...
                if (propertyResult.IsModelSet)
                {
                    ...
                    property.PropertySetter(model, ((FormCollection)propertyResult.Model).Files);
                }
