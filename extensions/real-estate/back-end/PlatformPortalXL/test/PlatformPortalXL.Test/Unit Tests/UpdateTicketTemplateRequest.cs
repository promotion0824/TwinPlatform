...
{
    public class UpdateTicketTemplateRequestTests
    {
        private List<(string Name, string Message)> _errors = new List<(string Name, string Message)>();
        private UpdateTicketTemplateRequest _request;

        public UpdateTicketTemplateRequestTests()
        {
            // Valid request
             _request = new UpdateTicketTemplateRequest
            {
        ...
        [InlineData("(555) 555-1212")]
        [InlineData("555.555.1212")]
        public void UpdateTicketTemplateRequest_Validate_success(string phone)
        {
        ...
        public void UpdateTicketTemplateRequest_Validate_invalid_email(string emailAddress)
        {
        ...
        public void UpdateTicketTemplateRequest_Validate_email_too_long(string emailAddress)
        {
            _request.ReporterEmail = emailAddress;
        ...
        [InlineData("")]
        [InlineData("  ")]
        public void UpdateTicketTemplateRequest_Validate_email_required(string emailAddress)
        {
            _request.ReporterEmail = emailAddress;
        ...
        public void UpdateTicketTemplateRequest_Validate_invalid_startdate(string startDate)
        {
        ...
        [InlineData("")]
        [InlineData("   ")]
        public void UpdateTicketTemplateRequest_Validate_required_summary(string summary)
        {
        ...
        [InlineData("")]
        [InlineData("   ")]
        public void UpdateTicketTemplateRequest_Validate_required_description(string description)
        {
        ...
        [InlineData("")]
        [InlineData("   ")]
        public void UpdateTicketTemplateRequest_Validate_required_phone(string phone)
        {
            _request.ReporterPhone = phone;
        ...
        public void UpdateTicketTemplateRequest_Validate_invalid_phone(string phone)
        {
            _request.ReporterPhone = phone;
        ...
        public void UpdateTicketTemplateRequest_Validate_invalid_summary(string summary)
        {
            _request.Summary = summary;
        ...
        [InlineData("")]
        [InlineData("   ")]
        public void UpdateTicketTemplateRequest_Validate_required_reportername(string name)
        {
        ...
        public void UpdateTicketTemplateRequest_Validate_invalid_reportername(string name)
        {
            _request.ReporterName = name;
