...
namespace Willow.Tests.Infrastructure
{
    public class MainServiceStartup<TOriginalStartup> where TOriginalStartup : class
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var assetsStore = new MemoryStore(); 
                
            assetsStore.Put("es/assets.csv",     _esAssets); 
            assetsStore.Put("es/properties.csv", _esProperties); 
                
            services.AddSingleton<IBlobStore>( p=> 
            { 
                var store = new MemoryStore(); 
                
                store.Put("bob", "bobsyouruncle"); 
                
                return store; 

            });
            services.AddSingleton<IAssetLocalizerFactory>
            ( 
               p=> new AssetLocalizerFactory(p.GetRequiredService<IMemoryCache>(), 
                                              assetsStore, 
        ...
        private const string _esAssets = "ModelId,EnglishValue,TranslatedValue\r\n1:house,House,Casa\r\n1:car,Car,Coche\r\n1:airplane,Airplane,Avión";

        private const string _esProperties = "ModelId,EnglishValue,TranslatedValue\r\nblah,blah,blah"; 
        ...
        public void Configure(IApplicationBuilder app, IServiceProvider serviceProvider)
        {
            ...
            serviceProvider.InvokeMethod(
                ...
                new Dictionary<Type, object>()
                {
                    ...
                    [typeof(IApiVersionDescriptionProvider)] = null
                });
        }
