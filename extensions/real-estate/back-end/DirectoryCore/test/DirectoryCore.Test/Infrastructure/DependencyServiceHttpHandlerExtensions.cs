...
namespace Willow.Tests.Infrastructure
{
    public static class MockHttpMessageHandlerExtensions
    {
        ...
        {
            return setup.ReturnsResponse(
                JsonSerializerExtensions.Serialize(content),
                "application/json"
            );
        }
        ...
        public static ISetupSequentialResult<Task<HttpResponseMessage>> ReturnsJson<T>(
        ...
        public static IReturnsResult<HttpMessageHandler> ReturnsJsonUsingNewtonsoft<T>(
            this ISetup<HttpMessageHandler, Task<HttpResponseMessage>> setup,
            T content
        )
        {
        ...
        public static ISetupSequentialResult<
            Task<HttpResponseMessage>
        > ReturnsJsonUsingNewtonsoft<T>(
            this ISetupSequentialResult<Task<HttpResponseMessage>> setup,
            T content
        )
        {
        ...
        public static ISetup<HttpMessageHandler, Task<HttpResponseMessage>> SetupRequest(
            this DependencyServiceHttpHandler handler,
            HttpMethod method,
            string requestUrl
        )
        {
        ...
        {
            return handler.HttpHandler.SetupRequest(
                method,
                $"{handler.BaseUrl}/{requestUrl}",
                match
            );
        }
        ...
        {
            return handler.HttpHandler.SetupRequestSequence(
                method,
                $"{handler.BaseUrl}/{requestUrl}"
            );
        }
        ...
        public static ISetup<
            HttpMessageHandler,
            Task<HttpResponseMessage>
        > SetupRequestWithExpectedBody<TRequestJsonType>(
            this DependencyServiceHttpHandler handler,
            HttpMethod method,
            string requestUrl,
            TRequestJsonType expectedRequestBody
        )
        {
            return handler.SetupRequest(
                method,
                requestUrl,
                async (message) =>
                {
                    var stringContent = await message.Content.ReadAsStringAsync();
                    var requestBody = JsonSerializerExtensions.Deserialize<TRequestJsonType>(
                        stringContent
                    );
        ...
        public static ISetup<
            HttpMessageHandler,
            Task<HttpResponseMessage>
        > SetupRequestWithExpectedFileContent(
            this DependencyServiceHttpHandler handler,
            HttpMethod method,
            string requestUrl,
        ...
        )
        {
            return handler.SetupRequest(
                ...
                async (message) =>
                {
                    ...
                    var filePart = multipartContent.FirstOrDefault(
                        part => part.Headers.ContentDisposition.Name == fileParameterName
                    );
