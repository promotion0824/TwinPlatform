...
namespace Willow.Tests.Infrastructure
{
    ...
    public class ServerFixtureConfiguration
    {
        ...
        public List<DependencyServiceConfiguration> DependencyServices { get; set; } =
            new List<DependencyServiceConfiguration>();
        public Action<IServiceCollection> MainServicePostConfigureServices { get; set; }
        public Action<
            IConfigurationBuilder,
            TestContext
        > MainServicePostAppConfiguration { get; set; }
    ...
    public class ServerFixture : IDisposable
    {
        ...
        public ServerFixture(
            ServerFixtureConfiguration fixtureConfiguration,
        ...
        {
            var wrappedStartupType = typeof(MainServiceStartup<>).MakeGenericType(
                fixtureConfiguration.StartupType
            );
            ...
            var host = new WebHostBuilder()
                ...
                .ConfigureAppConfiguration(
                    (context, configuration) =>
                    {
                        ...
                        fixtureConfiguration.MainServicePostAppConfiguration?.Invoke(
                            configuration,
                            _testContext
                        );
                    }
        ...
        )
        {
            ...
            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(
                ...
                JsonSerializerExtensions.Serialize(token)
            );
            return client;
        }
    }
