...
public class ResiliencePipelineService(ResiliencePipelineProvider<string> pipelineProvider)
    : IResiliencePipelineService
{
    ...
    {
        return await pipelineProvider
            .GetPipeline(ResiliencePipelineName.Retry)
            .ExecuteAsync(callback, context, state);
    }
    ...
    )
    {
        return await pipelineProvider
            .GetPipeline(ResiliencePipelineName.Retry)
            .ExecuteAsync(callback, state, cancellationToken);
    }
