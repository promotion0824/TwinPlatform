...
namespace Willow.Communications.Function.UnitTests
{
    public class CommunicationsServiceUnitTests
    {
        ...
        [InlineData("Contractor", "fr", null, "fr", "Bienvenue Fred Flintstone", "<html><title>Bienvenue Fred Flintstone</title><body>Cher Fred Flintstone, Tu es maintenant un utilisateur, dude.</body></html>")]
        ...
        public async Task CommunicationsServiceFunction_PushNotification_Run_Validation_Error(string userType)
        {
            ...
            Assert.Equal("Please enter one of the allowable values: customeruser, Customer, Contractor, supervisor.", _logger.Entries[1].Message);
