    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddApiServices(this IServiceCollection services, IConfiguration configuration, IWebHostEnvironment env)
        {
            ...
            services.AddMvc(options => {
                    options.Filters.Add<MobileExceptionFilter>();
                })
                .AddJsonOptions(opt =>
                {
        ...
        public static IServiceCollection AddDigitalTwinApi(this IServiceCollection services, IConfiguration configuration) 
        {
            var storageConfig = configuration.GetSection("Azure:BlobStorage");

            services.Configure<BlobStorageConfig>(storageConfig);

            services.AddAzureBlobStorage<MobileXL.Features.Assets.AssetsController>(configuration);

            services.AddSingleton<IContentTypeProvider, FileExtensionContentTypeProvider>();

            services.AddScoped<IDigitalTwinApiService, DigitalTwinApiService>();
