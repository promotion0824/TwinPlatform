...
{
	public class GetAssetsOnFloorByCategoryAndSearchWordTest : BaseTest
	{
        ...
        protected override ICollection<KeyValuePair<string, string>> QueryParam => new Dictionary<string, string>
			{
				{ "searchKeyword", "FSD-49-10" },
				{ "floorId", "9d3dd93d-bcee-4686-a1a0-264146118dd2" },
				{ "categoryId", "55c808b3-9256-5823-445d-726b3c717864" }
			};

		public static GetAssetsOnFloorByCategoryAndSearchWordTest Create()
		{
			return new GetAssetsOnFloorByCategoryAndSearchWordTest();
		}
