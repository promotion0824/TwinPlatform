...
{
	public class GetLivedataExtraPropAssetsOnFloorTest : BaseTest
	{
		...
		public static GetLivedataExtraPropAssetsOnFloorTest Create()
		{
			return new GetLivedataExtraPropAssetsOnFloorTest();
		}
