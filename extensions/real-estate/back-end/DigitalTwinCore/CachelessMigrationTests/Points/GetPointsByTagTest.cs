...
{
    public class GetPointsByTagTest : BaseTest
    {
        protected override bool AdxImplemented => true;
        protected override string UrlFormat => $"{{0}}/sites/{UatData.SiteId1MW}/points/bytag/sensor";

        public static GetPointsByTagTest Create()
        {
            return new GetPointsByTagTest();
        }
