...
namespace DigitalTwinCore.Database.DbUp
{
    /// <summary>
    ...
    // ReSharper restore CheckNamespace
    {
            ...
            string collation = null)
        {
            ...
            string collationString = string.IsNullOrEmpty(collation) ? "" : $@" COLLATE {collation}";
            sqlCommandText = $@"CREATE DATABASE [{databaseName}]{collationString};";
