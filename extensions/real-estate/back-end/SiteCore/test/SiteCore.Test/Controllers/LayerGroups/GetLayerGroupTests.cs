...
{
    public class GetLayerGroupTests : BaseInMemoryTest
    {
        public GetLayerGroupTests(ITestOutputHelper output) : base(output)
        {
        }

        [Fact]
        public async Task ThereIsLayerGroup_GetLayerGroup_ReturnsLayerGroup()
        {
            ...
            using (var client = server.CreateClient(null))
            {
                ...
                result.Should().BeEquivalentTo(LayerGroupDto.MapFrom(LayerGroupEntity.MapToDomainObject(layerGroup)));
            }
        }
    }
}
