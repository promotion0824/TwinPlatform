...
using SiteCore.Infrastructure.Security;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static void AddJwtAuthentication(this IServiceCollection services, string authenticationDomain, string audience, AzureADB2CConfiguration azureB2COptions, IWebHostEnvironment env)
        {
            ...
            {
                options.Audience = azureB2COptions.ClientId;
                options.Authority = $"https://login.microsoftonline.com/{azureB2COptions.TenantId}";
                options.TokenValidationParameters = new IdentityModel.Tokens.TokenValidationParameters
                {
                    ...
                    ValidIssuer = $"https://login.microsoftonline.com/{azureB2COptions.TenantId}/v2.0"
                };
            });
