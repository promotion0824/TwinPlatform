...
WHILE 1=1
  BEGIN 
    ...
    BEGIN TRY
	  ...
	  DECLARE @select varchar(256) = 'SELECT ''' + @sitePrefix + ''' as Prefix, NEXT VALUE FOR dbo.TicketSequenceNumber_' + @sitePrefix + @siteSuffix + ' as NextNumber';
	...
	BEGIN CATCH
		...
		BEGIN TRY
			...
			DECLARE @select2 varchar(512) = 'CREATE SEQUENCE dbo.TicketSequenceNumber_' + @sitePrefix + @siteSuffix + ' AS bigint START WITH ' + CAST(@startNumber as varchar(16)) + ' INCREMENT BY 1';
