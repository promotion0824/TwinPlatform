...
namespace WorkflowCore.Database.DbUp
{
/// <summary>
...
// ReSharper restore CheckNamespace
{
        ...
        string collation = null)
    {
        ...
        using (var connection = new SqlConnection(masterConnectionString))
        {
            ...
            string collationString = string.IsNullOrEmpty(collation) ? "" : string.Format(CultureInfo.InvariantCulture, @" COLLATE {0}", collation);
