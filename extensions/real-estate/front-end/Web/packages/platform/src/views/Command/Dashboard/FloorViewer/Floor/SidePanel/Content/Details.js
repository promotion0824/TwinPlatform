...
export default function Details({ assetId }) {
  ...
  return (
    <Fetch
      url={`/api/sites/${params.siteId}/assets/${assetId}`}
      headers={{ language }}
    >
      {(response) => (
        <Fetch
          url={`/api/sites/${params.siteId}/assets/${assetId}/pinOnLayer`}
          headers={{ language }}
          error={null}
        >
          {(pinOnLayerResponse) => {
            ...
            return (
              <Flex fill="content">
                ...
                <Flex>
                  ...
                  <Fetch
                    url={`/api/sites/${params.siteId}/assets/${asset.id}/files`}
                    progress={
