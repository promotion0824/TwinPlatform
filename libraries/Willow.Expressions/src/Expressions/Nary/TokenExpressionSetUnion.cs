...
namespace Willow.Expressions
{
    ...
    /// </summary>
    public class TokenExpressionSetUnion : TokenExpressionNary
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="TokenExpressionSetUnion"/> class
        /// </summary>
        public TokenExpressionSetUnion(TokenExpression left, TokenExpression right)
            : base(left, right)
        {
        }
        ...
        /// Creates a new instance of the <see cref="TokenExpressionSetUnion"/> class
        /// </summary>
        public TokenExpressionSetUnion(TokenExpression[] children)
            : base(children)
        {
        }
